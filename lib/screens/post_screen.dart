...
import 'package:demo/screens/comment_screen.dart';
...
class _PostScreenState extends State<PostScreen> {
  ...
  //? Like and Dislike
  void _handlePostLikeAndDislike(int postId) async {
    ApiResponse response = await likeUlikePost(postId);
  ...
  //? Delete Post
  void _handleDeleteData(int postId) async {
                        ...
                        children: [
                          kLikeandComment(
                            ...
                            post.selfLiked == true
                                ...
                                : Colors.black38,
                            () {
                              _handlePostLikeAndDislike(post.id ?? 0);
                            },
                          ),
                          Container(
                            height: 25,
